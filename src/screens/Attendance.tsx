...
const makeStyles = (C: any) => StyleSheet.create({
    ...
    prevDayBtn: { backgroundColor: C.orange + '20', paddingHorizontal: 20, paddingVertical: 12, borderRadius: 14 },
    ...
    suspChip: { flexDirection: 'row', alignItems: 'center', gap: 3, backgroundColor: '#92400E20', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 8 },
    ...
    batchChipActive: { backgroundColor: C.orange + '15', borderColor: C.orange },
    ...
    statPill: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: C.green + '15', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 10 },
    ...
    markAllBtn: { backgroundColor: C.green + '15', paddingHorizontal: 10, paddingVertical: 7, borderRadius: 10 },
    markAllText: { color: C.green, fontSize: 12, fontWeight: '800' },
    suspendBtn: { width: 34, height: 34, borderRadius: 10, backgroundColor: C.red + '15', alignItems: 'center', justifyContent: 'center' },
    ...
    studentBadge: { flexDirection: 'row', alignItems: 'center', gap: 3, backgroundColor: C.purple + '15', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6 },
    exemptBadge: { flexDirection: 'row', alignItems: 'center', gap: 3, backgroundColor: C.green + '15', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6 },
