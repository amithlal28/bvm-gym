...
const makeStyles = (C: any) => StyleSheet.create({
    ...
    filterChipActive: { backgroundColor: C.orange + '15', borderColor: C.orange },
    ...
    swipeAction: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: C.red + '15', borderTopRightRadius: 18, borderBottomRightRadius: 18, height: '100%' },
    ...
    memberCardSuspended: { opacity: 0.75, borderWidth: 1, borderColor: C.gold + '40' },
    avatar: { width: 48, height: 48, borderRadius: 14, alignItems: 'center', justifyContent: 'center' },
    avatarText: { fontSize: 18, fontWeight: '800' },
    memberName: { fontSize: 15, fontWeight: '700', color: C.text },
    memberPhone: { fontSize: 12, color: C.sub, marginTop: 2 },
    badge: { flexDirection: 'row', alignItems: 'center', gap: 3, backgroundColor: C.blue + '15', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6 },
    suspBadge: { flexDirection: 'row', alignItems: 'center', gap: 3, backgroundColor: C.gold + '15', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6 },
    ...
    membershipIcon: { width: 40, height: 40, borderRadius: 12, backgroundColor: C.green + '15', alignItems: 'center', justifyContent: 'center' },
    ...
    exChipActive: { backgroundColor: C.orange + '15', borderColor: C.orange },
