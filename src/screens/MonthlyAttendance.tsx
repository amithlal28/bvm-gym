...
const makeStyles = (C: any, isDark: boolean) => StyleSheet.create({
    ...
    overallBanner: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: C.green + '15', paddingHorizontal: 20, paddingVertical: 12 },
    ...
    suspBadge: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: C.gold + '15', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 10 },
    suspBadgeText: { fontSize: 12, fontWeight: '700', color: isDark ? C.gold : '#92400E' },
});
